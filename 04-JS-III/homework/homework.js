...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce(myFunction);
...
function promedioResultadosTest(resultadosTest) {
  ...
  return (resultadosTest.reduce(myFunction)/resultadosTest.length);
}
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  return arreglo.filter(myFunction).length;
